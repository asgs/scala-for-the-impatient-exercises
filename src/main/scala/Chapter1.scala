...
class Chapter1 {
  public void printAnswers()
  {
    ...
    println("8. A random alphanumeric string generated using BigInt with BigInt.probablePrime(200, util.Random).toString(36) is "  + BigInt().probablePrime(200, util.Random).toString(36)).toString());
